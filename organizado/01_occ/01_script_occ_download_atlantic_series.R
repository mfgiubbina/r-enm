# script description #
# script: occurrences - download atlantic series
...
# directoty
path <- "/home/mude/data/gitlab/r-enm/data/01_occ/atlantic_series/v02"
setwd(path)
dir()
...
# import sites
# 1. need edit ATLANTIC_SM_Study_Site.csv: remove space from first column ID
# 2. need fix line 69
...
# download metadata
download.file("https://esajournals.onlinelibrary.wiley.com/action/downloadSupplement?doi=10.1002%2Fecy.2785&file=ecy2785-sup-0001-Supinfo.zip",
              "ecy2785-sup-0001-Supinfo.zip")

# unzip
unzip("ecy2785-sup-0001-Supinfo.zip")
system("unrar ecy2785-sup-0002-DataS1.rar")

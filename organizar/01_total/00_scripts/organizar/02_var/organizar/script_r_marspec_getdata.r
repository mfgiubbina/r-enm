...
#' marspec_getdata
#' 
#' download marspec layers. more info at www.marspec.org
#' 
#' @usage marspec_getdata(scenario, resolution, variable, path)
#' 
#' @param scenario - select a temporal scenario. 
#' Options are: "paleo", "modern"
#' @param resolution - select the variable resolutuion.
#' Options are: "10m", "5m", "2_5m", "30s"
#' @param variable - select the variable type.
#' Options are: "bathymetry", "biogeo"
#' @param path - inform path.
#' Options is: "your_folder_path/"
#'
#' Observation: The options "" indicator download from all data.

###--------------------------------------------------------------------------###

# function
marspec_getdata <- function(scenario, resolution, variable, path){

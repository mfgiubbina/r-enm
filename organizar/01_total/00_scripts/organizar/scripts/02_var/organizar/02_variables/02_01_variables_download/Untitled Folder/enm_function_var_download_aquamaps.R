### enm package - function download marspec ###
...
# function
marspec_download <- function(scenario, path){
  ...
  # directory
  setwd(path)
  dir.create("aquamaps", showWarnings = FALSE)
  setwd("aquamaps")
  
  # url
  url.zip <- "https://www.aquamaps.org/main/files/HCAF_v6.zip"
  url.meta <- "https://www.aquamaps.org/main/files/HCAFMetadata_v6.xls"
